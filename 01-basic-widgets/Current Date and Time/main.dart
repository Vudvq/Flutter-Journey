    ...
    return Scaffold(
      ...
      body:Center(
        child: Container(
            ...
            child: Column(
              children: [
                Text('Current Time: ${time.year}',style: TextStyle(fontSize: 21),),
                Text('Current Month: ${time.month}',style: TextStyle(fontSize: 21),),
                Text('Current Hour: ${time.hour}',style: TextStyle(fontSize: 21),),
